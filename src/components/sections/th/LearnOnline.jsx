...
const benefits = [
  {
    ...
    description: 'Study comfortably from home, your office, or wherever you are — no commute needed.',
    stat: '100%',
    statLabel: 'Online',
  },
  {
    ...
    title: 'Focused, Personalized Guidance',
    description: 'Receive one-on-one or small-group instruction — your teacher\'s full attention on your specific needs.',
    stat: '1-on-1',
    statLabel: 'Format',
  },
  {
    ...
    description: 'Structured lessons with expert feedback mean every session moves you meaningfully forward.',
    stat: '2x',
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex-1">
                    <h3 className="text-[15px] font-bold text-[#1a202c] transition-colors duration-300 group-hover:text-[#e8400a]">
                      {item.title}
                    </h3>
                    <p className="mt-1 text-[13px] leading-[1.7] text-[#4a5568]">
                      {item.description}
                    </p>
                  </div>
                  ...
                  <div className="relative z-10 ml-auto shrink-0 text-right">
                    <p
                      className="text-[22px] font-extrabold leading-none transition-colors duration-300"
                      style={{ color: isActive ? '#e8400a' : '#cbd5e0' }}
                    >
                      {item.stat}
                    </p>
                    <p
                      className="mt-1 text-[10px] font-semibold uppercase tracking-wide transition-colors duration-300"
                      style={{ color: isActive ? '#f15a22' : '#94a3b8' }}
                    >
                      {item.statLabel}
                    </p>
                  </div>
