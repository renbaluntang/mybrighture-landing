...
function Cta() {
  ...
  return (
    <section id="contact" className="px-4 pb-20 pt-10 sm:px-8 sm:pt-14 lg:px-16">
      ...
      >
        <div className="relative overflow-hidden rounded-[28px] border border-[#bae6fd]/50 bg-[radial-gradient(140%_120%_at_50%_0%,#f0f9ff_0%,#e0f2fe_45%,#bae6fd_100%)] shadow-[0_18px_40px_-22px_rgba(2,132,199,0.25)]">
          <CtaAmbientBackground />
          <CtaCloudLayer />

          {/* Three-column grid: image | content | image */}
          <div className="relative z-10 grid items-center gap-2 px-2 sm:grid-cols-[minmax(0,1.25fr)_minmax(0,1fr)] sm:gap-6 sm:px-4 lg:justify-center lg:gap-0 lg:grid-cols-[minmax(170px,230px)_minmax(340px,520px)_minmax(170px,230px)] lg:px-6">
            ...
            <div className="mx-auto w-full max-w-[760px] px-4 pb-8 pt-3 text-center sm:px-6 sm:py-10 lg:order-2 lg:max-w-[520px] lg:px-5 lg:py-12">
              {/* Badge */}
              <p className="inline-flex rounded-full border border-[#7dd3fc] bg-white/60 px-3 py-1 text-[10px] font-semibold tracking-[0.03em] text-[#0369a1] sm:px-4 sm:text-[12px] backdrop-blur-sm shadow-sm opacity-90">
              ...
              <h2 className="mt-4 text-[26px] font-extrabold leading-[1.1] tracking-[-0.02em] sm:text-[30px] lg:text-[32px]">
                <span className="text-[#e8400a]">Try a Free</span>
                <br />
                <span className="text-[#1a2340]">Pronunciation Lesson</span>
              </h2>

              {/* Body */}
              <p className="mx-auto mt-4 max-w-sm text-[13px] leading-[1.8] text-[#334155] sm:text-[14px]">
                Experience our teaching style with a structured free trial. See how expert feedback and clear guidance can make an immediate difference.
              </p>
              ...
              <div className="mt-5">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-[12px] font-semibold text-[#475569] underline-offset-2 transition-all duration-200 hover:text-[#0369a1] hover:underline sm:text-[13px]"
                >
