...
const programs = [
  {
    ...
    description: 'Communicate confidently in meetings, interviews, and international teamwork.',
    accent: '#e8400a',
  },
  {
    id: '02',
    ...
    description: 'Write professional emails, reports, and proposals with clear structure and tone.',
    accent: '#f15a22',
  },
  {
    id: '03',
  ...
  },
  {
    id: '04',
    emoji: '🗣',
    title: 'Speech Fluency & Structure',
    description: 'Speak more smoothly and naturally by improving intonation, stress, rhythm, emotion, and pacing.',
    accent: '#2d5a8e',
  },
  {
    id: '05',
    emoji: '🤝',
    title: 'Professional & Social English',
    description: 'Build natural confidence in workplace and international networking settings.',
    accent: '#7b4ea8',
  },
  {
    id: '06',
    emoji: '📝',
    title: 'Exam & Career English',
    description: 'Targeted support for IELTS, job interviews, and workplace English assessments.',
    accent: '#0d7a5f',
  },
]
    ...
    >
      ...
      >
        <div
          ...
          style={{ background: `linear-gradient(to right, ${program.accent}, ${program.accent}44)`, width: isTouchActive ? '100%' : '0%' }}
        />
        <div className="mb-5 flex items-center justify-between">
          <div
            ...
            style={{ background: `${program.accent}12`, transform: isTouchActive ? 'scale(1.05)' : undefined }}
          >
            {program.emoji}
          </div>
          <span className="font-mono text-[10px] font-bold tracking-widest" style={{ color: `${program.accent}55` }}>
            {program.id}
          </span>
        </div>
        <h3 className="text-[15px] font-bold leading-snug tracking-tight text-[#12151d]">{program.title}</h3>
        <p className="mt-2.5 text-[13px] leading-[1.75] text-[#64748b]">{program.description}</p>
      </div>
    </article>
  )
}
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-sm text-[14px] leading-[1.8] text-[#64748b] sm:text-right">
              Gain professional confidence with practical, goal-oriented programs.
            </p>
          </div>
