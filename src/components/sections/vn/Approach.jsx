...
const pillars = [
  ...
  },
  {
    ...
    label: 'Accuracy & Logic',
    description: 'We focus on logical structures and professional expression — helping you move beyond basic grammar patterns.',
    accent: '#f15a22',
  },
  {
    icon: (
    ...
    label: 'Workplace Standards',
    description: 'Lessons are designed to meet the real communication expectations of international teams and global businesses.',
    accent: '#1a2340',
  },
]
  ...
  return (
    <section className="relative overflow-hidden bg-[#f9fafb] px-6 py-20 sm:px-10 lg:px-16">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1680px]">
        ...
        >
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.14em] text-[#e8400a]">A Structured, Career-Focused Approach</p>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-sm text-[14px] leading-[1.8] text-[#64748b] sm:text-right">
              Each class targets specific communication skills so progress is measurable, not vague.
            </p>
          </div>
