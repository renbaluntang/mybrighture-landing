...
const feedbackItems = [
  {
    ...
    label: 'Live Verbal Corrections',
    detail: 'Immediate, real-time corrections during the lesson so you can adjust your pronunciation and intonation on the spot.',
    color: '#e8400a',
  },
  {
    id: 'written',
    ...
    detail: 'Feedback on grammar, vocabulary, and sentence structure, plus clear improvement goals for your next class.',
    color: '#f15a22',
  },
]
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1680px]">
        ...
        >
          ...
          <p className="mt-5 text-[15px] leading-[1.8] text-[#4a5568]">
            To ensure consistent progress, every class includes structured, actionable feedback.
          </p>
        </div>
          ...
          <div ref={cardsRef} className="flex flex-col gap-5">
            ...
            >
              <p className="text-[14px] leading-[1.8] text-[#5a3a2e]">
                ...
                You will always know what to fix and <em>how</em> to fix it.
              </p>
            </div>
          </div>
