    ...
    <section id="hero" className="relative pt-2 pb-8 md:pt-0 md:pb-10">
      <div className="grid w-full overflow-hidden md:max-h-[620px] md:grid-cols-2 xl:mx-auto lg:max-h-none lg:h-[87vh] xl:w-10/12">
        ...
        >
          ...
          <h1
            className="h-auto w-auto max-w-full border-0 text-left text-[2rem] font-extrabold not-italic leading-[1] tracking-[-0.018em] text-[#121a35] sm:text-[2.8rem] lg:text-[3.2rem] xl:text-[3.85rem] [transform-origin:bottom_center] [z-index:1]"
            style={{
          ...
          >
            英語の悩みは、
            <br />
            <span className="text-[#f24c18]">発音矯正</span>で
            <span className="text-[#f24c18]">改善</span>する
          </h1>
          <p
            className="h-auto w-auto max-w-[620px] flex-1 px-0 text-justify text-[0.98rem] font-medium leading-[1.55] text-[#3f4a61] sm:text-[1.02rem] lg:text-[1rem] xl:text-[1.06rem]"
            style={{
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs font-medium text-[#5a6475]">
                受講者数 <span className="font-bold text-[#121a35]">1,200+</span> 名
              </p>
            </div>
          </div>
          </div>
