  ...
  return (
    <section id="lessons" className="px-4 pb-20 pt-16 sm:px-8 lg:px-16 lg:pb-24 lg:pt-20">
      <div className="mx-auto w-full max-w-[1680px]">
        <p className="text-[32px] font-bold leading-[1.15] text-[#1f2128] sm:text-[36px] md:text-[40px]">Brighture&apos;s <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e8400a] to-[#ff7b54]">Pronunciation Lessons</span></p>
