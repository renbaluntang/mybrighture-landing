...
const benefits = [
  {
    ...
    title: 'Learn from Anywhere in Taiwan',
    description: 'Study from home, your office, or anywhere — all classes conducted online with full structure and high expectations.',
    stat: '100%',
    statLabel: 'Online',
  },
  {
    ...
    description: 'Every session follows a structured plan — maintaining high standards for accuracy and clarity, not casual chat.',
    stat: 'Focused',
    statLabel: 'Coaching',
  },
  {
    ...
    title: 'Professional Growth, Measured',
    description: 'Focused coaching for professional communication growth — every lesson is a measurable step forward.',
    stat: '2x',
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <p className="mt-5 text-[15px] leading-[1.8] text-[#4a5568]">
              All classes are conducted online — maintaining structured lesson plans, high expectations for accuracy and clarity, and focused coaching for professional growth.
            </p>
            <div className="mt-8">
              <a
