...
const feedbackItems = [
  {
    ...
    detail: 'Real-time corrections and guidance during and after every class so you understand exactly what to fix.',
    color: '#e8400a',
  },
  {
    id: 'written',
    ...
    detail: 'Detailed post-lesson notes highlighting corrections, structure, and clear improvement points — so progress is always visible.',
    color: '#f15a22',
  },
]
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1680px]">
        ...
        >
          ...
          <p className="mt-5 text-[15px] leading-[1.8] text-[#4a5568]">
            To ensure consistent progress, every class includes structured, actionable feedback — so you always know what to improve and <em>how</em> to improve it.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1fr] lg:gap-10 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div ref={cardsRef} className="flex flex-col gap-5">
            {feedbackItems.map((item, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-[17px] font-bold leading-snug" style={{ color: '#1a202c' }}>{item.label}</h3>
                    <p className="mt-2 text-[14px] leading-[1.75] text-[#4a5568]">{item.detail}</p>
                  </div>
                </div>
                <div
            ...
            >
              <p className="text-[14px] leading-[1.8] text-[#5a3a2e]">
                ...
                You&apos;ll always know what to improve and <em>how</em> to improve it — not just that you spoke.
              </p>
            </div>
          </div>
          ...
          >
            <div className="overflow-hidden rounded-2xl border border-[#e2e8f0] bg-gradient-to-br from-[#1a2340] to-[#2d4070] p-8 text-white shadow-[0_20px_50px_-15px_rgba(26,35,64,0.35)] sm:p-10">
              <p className="text-sm font-bold uppercase tracking-[0.1em] text-[#ff8c6b]">Why it works</p>
